...
function pesquisar(){
	...
	$("#listagem").load("../../ajax/pag/ajCorretora.php",{select:value});
	return false;    
}
...
function processaInclusao(){
    ...
    $("#listagem").load("../../ajax/pag/ajCorretoraInclusao.php",dados);
    return false;
}   
function corretoraElimina(id){
		  var url="../../ajax/pag/ajCorretoraElimina.php?id="+id;
				...
				if (xhr.readyState == 4) {
					if (xhr.status == 200)
                        if(xhr.responseText=="DEU RUIM"){
                           ...
                           alert("Corretora eliminada com sucesso!");
                           pesquisar();
                           }
					}
				}
...
function btnAlterar(id,logo,cnpj,corretora,nome_abrev,cep,endereco,numero,complemento,bairro,cidade,uf,situacao,telefone){
    $("#id").val(id);            
    $("#cpf").val(cnpj);
    $("#txtCorretora").val(corretora);
...
function contatoCorretora(id){
    $("#contatoCorretora").load("../../ajax/pag/ajCorretoraContato.php/?id="+id);
    return false;                                                  
};