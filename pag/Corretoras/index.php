...
<!------------------Botão Incluir e pesquisa -------------------->             
             ...
             <div class="row">
                 <div class="col-md-4">
                    ...
                    <button type="button" class="botoes" data-toggle="modal" data-target="#incluirCorretora" onClick="btnIncluir()">
                      Incluir
                    </button>  
                 </div>
                 <div class="col-md-8">
...
<!-------------------Fim Botão Pesquisa----------------------------------------------->   
             <div id="listagem">
                 <?php include "../../ajax/pag/ajCorretora.php";?>
             </div>
        </div>

<!-- Modal Inclusão-->
<div class="modal fade" id="incluirCorretora" tabindex="-1" aria-labelledby="incluirCorretoraLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="incluirCorretoraLabel">Corretora</h5>
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="txtCorretora" class="form-label">Nome Corretora</label>
            <input type="text" class="form-control" id="txtCorretora" name="txtCorretora" aria-describedby="corretora" required  disabled>
          </div>
          <div class="mb-3">
            <label for="txtNomeAbrev" class="form-label">Apelido</label>
          ...
          <div class="mb-3">
            <label for="txtObservacao" class="form-label">Telefone</label>
...
<!-----------  MODAL Contato --------->
<div class="modal fade" id="contatosCorretora" tabindex="-1" aria-labelledby="contatosCorretoraLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="contatosCorretoraLabel">Contatos Corretora</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <div id="contatoCorretora"></div>
        <div class="modal-footer" >
...
?>
<script src="../../js/pag/jsCorretora.js.php"></script> 
